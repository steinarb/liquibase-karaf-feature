...
** Project status
[[https://maven-badges.sml.io/sonatype-central/no.priv.bang.karaf/liquibase-core-karaf][file:https://maven-badges.sml.io/sonatype-central/no.priv.bang.karaf/liquibase-core-karaf/badge.svg]]
...
|------------------------+----------+-------------------+-------------------------+--------------------------------------------------------------|
| <2026-08-28 Fri 22:23> |    5.0.4 |             5.0.4 |                         |                                                              |
| <2026-05-17 Sun 21:35> |    5.0.3 |             5.0.3 |                         |                                                              |
| <2026-05-03 Sun 19:19> |    5.0.2 |             5.0.2 |                         |                                                              |
| <2026-01-24 Sat 23:54> |    5.0.1 |             5.0.1 |                         | First liquibase 5 release of karaf feature                   |
...
To install this feature:
 1. start karaf and give the following commands to the karaf console:
    #+BEGIN_EXAMPLE
      feature:repo-add mvn:no.priv.bang.karaf/liquibase-core-karaf/5.0.4/xml/features
...
<features xmlns="http://karaf.apache.org/xmlns/features/v1.4.0" name="ukelonn.bundle.db.liquibase">
    <repository>mvn:no.priv.bang.karaf/liquibase-core-karaf/5.0.4/xml/features</repository>
...
I have created the project [[https://github.com/steinarb/liquibase-sample#liquibase-sample][liquibase-sample]] to test new versions of this karaf feature.
