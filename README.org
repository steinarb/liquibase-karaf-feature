...
Apart from the issues worked around in the previous section I see two problems currently:
 1. I think JSON parsers and YAML parsers may not work in the current (4.15.0) version, based on these messages in karaf.log
    #+begin_example
      2022-09-10T08:28:30,566 | INFO  | features-3-thread-1 | servicelocator                   | 137 - org.liquibase.core - 4.15.0 | Cannot load service: liquibase.parser.ChangeLogParser: liquibase.parser.core.json.JsonChangeLogParser Unable to get public no-arg constructor
      2022-09-10T08:28:30,574 | INFO  | features-3-thread-1 | servicelocator                   | 137 - org.liquibase.core - 4.15.0 | Cannot load service: liquibase.parser.ChangeLogParser: liquibase.parser.core.yaml.YamlChangeLogParser Unable to get public no-arg constructor
      2022-09-10T08:28:30,675 | INFO  | features-3-thread-1 | servicelocator                   | 137 - org.liquibase.core - 4.15.0 | Cannot load service: liquibase.change.Change: liquibase.change.core.LoadDataChange Unable to get public no-arg constructor
      2022-09-10T08:28:30,676 | INFO  | features-3-thread-1 | servicelocator                   | 137 - org.liquibase.core - 4.15.0 | Cannot load service: liquibase.change.Change: liquibase.change.core.LoadUpdateDataChange Unable to get public no-arg constructor
    #+end_example
